<%@ page language="C#" autoeventwireup="true" enablesessionstate="True" inherits="App_BasicEdit_Dictionary, ECI.Web" enableviewstatemac="false" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function publish() {
            msg.loading();
            eci.post("../Basic/data/Data.ashx", "Publish", {})
        }

        function publishAll() {
            msg.loading();
            eci.post("../Basic/data/Data.ashx", "PublishAll", {})
        }
            ...
            <div id="divQuery" style="width: 100%;">
                <table id="tbQuery" runat="server" class="grid" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td class="lbl">类型</td>
                        <td>
                            <asp:EDropDownList runat="server" ID="ddlTYPE" DataField="TYPE" Query="TYPE|string|=" Width="85%" ReadOnly="true">
                    ...
                    <tr>
                        <td class="lbl"><asp:ELabel runat="server" ID="lblCompany">归属公司</asp:ELabel> </td>
                        <td>
                            <asp:ETextBox runat="server" ID="txtCompanyCode" DataField="COMPANY_CODE" Width="85%" Query="COMPANY_CODE|string|=" ImeDisabled="false" AutoUpper="true"></asp:ETextBox>
                        </td>
                        <td class="lbl">&nbsp;</td>
                        <td>
                            &nbsp;</td>
