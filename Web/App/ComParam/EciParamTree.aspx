<%@ page language="C#" autoeventwireup="true" inherits="App_COMParam_EciParamTree, ECI.Web" enableviewstatemac="false" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            var groupCode = $("#hidGroupCode").val();

            var url = 'GroupData.aspx?type=load&dps=' + eci.guid()+"&groupCode="+groupCode;
            if (sysCode) {
                url += "&SysCode=" + sysCode;
            }
    ...
    <form id="form1" runat="server">
        ...
        <input type="hidden" id="hidGroupCode" runat="server" />
                    ...
                    <tr>
                        <td>
                            <div class="toolbar">
                                ...
                                <%--<asp:ECheckBox runat="server" Text="新窗口编辑" ID="chkNew" />--%>
                            </div>
