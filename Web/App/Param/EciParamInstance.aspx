<%@ page language="C#" autoeventwireup="true" inherits="App_System_frmEciParamInstance, ECI.Web" enableviewstatemac="false" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="root">
            ...
            <div id="toolbar" class="toolbar" style="padding-top: 2px;">
                ...
                <asp:Label runat="server" Text="版本:" ID="lblVersion"></asp:Label>
                ...
                <div style="float: right; margin-right: 5px;">
                    <asp:EButton runat="server" ID="btnManage" Visible="false" Text="管理" Icon="tool" IsClient="true" OnClientClick="manage();" />
                    <asp:EButton runat="server" ID="btnDebug" Visible="false" Text="接口调试" Icon="cog" IsClient="true" OnClientClick="debugAction();" />
                </div>
