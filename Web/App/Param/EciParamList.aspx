<%@ page language="C#" autoeventwireup="true" inherits="App_System_frmEciParamList, ECI.Web" enableviewstatemac="false" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <div id="toolbar">
                ...
                <asp:EButton runat="server" ID="btnBatchEdit" Text="批量维护" Icon="edit" OnClientClick="batchEditAction();" IsClient="true" />
                ...
                <div style="float:left;margin-left:10px;font-size:13px;color:brown;line-height:30px;">
            ...
            <div id="datagrid">
                ...
                <asp:EGridView ID="gvData" Layout="toolbar,pagetitle,30,tbQuery" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="PARAM_NAME" HeaderText="参数名称" SortExpression="PARAM_NAME" ItemStyle-Width="300"></asp:BoundField>
                        <asp:BoundField DataField="PARAM_KEY" HeaderText="参数编码" SortExpression="PARAM_KEY" ItemStyle-Width="300" ItemStyle-HorizontalAlign="Left"></asp:BoundField>
