<%@ page language="C#" autoeventwireup="true" inherits="App_System_frmEciParamEdit, ECI.Web" enableviewstatemac="false" %>
            ...
            <div>
                <table id="tbEdit" class="grid" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td  >
                            <asp:ETextBox runat="server" ID="txtParamValue" DataField="PARAM_VALUE" Width="94%"></asp:ETextBox></td>
