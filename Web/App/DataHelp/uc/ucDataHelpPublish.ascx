<%@ control language="C#" autoeventwireup="true" inherits="App_DataHelp_uc_ucDataHelpPublish, ECI.Web" %>

<asp:EWindow runat="server" ID="divHead" Title="数据选择发布" Icon="world" Width="400" Height="200">
