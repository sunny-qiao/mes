...
public partial class AppMes_BaseData_frmMesBdGdzcList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdGdzcSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdGdzcDelete);
