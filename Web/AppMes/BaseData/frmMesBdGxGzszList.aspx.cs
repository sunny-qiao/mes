...
public partial class AppMes_BaseData_frmMesBdGxGzszList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdGxGzszSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdGxGzszDelete);
