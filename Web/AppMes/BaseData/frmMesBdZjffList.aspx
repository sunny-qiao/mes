<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdZjffList.aspx.cs" Inherits="AppMes_BaseData_frmMesBdZjffList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function addAction() {
            var url = "frmMesBdZjffEdit.aspx";
            eci.open(url);
        }

        function editAction(obj) {
            var key = $(obj).getKey();
            var url = "frmMesBdZjffEdit.aspx?key=" + key;
            eci.open(url);
        }
...
<body>
    <form id="form1" runat="server">
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="折旧方法"></asp:ETitle>
...
<th style="width: 20%"></th>
                        ...
                        <tr>
                        <td class="lbl">折旧方法编号</td>
<td><asp:ETextBox runat="server" ID ="txtBh"  DataField="BH" Query="A.BH|string|like" Width="85%"></asp:ETextBox></td>
                        <td class="lbl">折旧方法</td>
<td><asp:ECombox runat="server" ID ="cboZjff"  DataField="ZJFF" Query="A.ZJFF|string|=" AddEmpty="true" ECIType="ZJFF" Width="85%"></asp:ECombox></td>
            ...
            <div id="datagrid">
                ...
                <asp:EGridView ID="gvData" Layout="divQuery,toolbar,pagetitle" runat="server" 
                    ...
                    <Columns>
                      ...
                      <asp:BoundField DataField="BH" HeaderText="折旧方法编号" SortExpression="BH"  ItemStyle-Width="150"></asp:BoundField>
