...
public partial class AppMes_BaseData_frmMesBdDbList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdDbSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdDbDelete);
