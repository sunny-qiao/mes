<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdMjDyyxEdit.aspx.cs" Inherits="AppMes_BaseData_frmMesBdMjDyyxEdit" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>模具子表-模具对应用芯信息维护</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="模具子表-模具对应用芯信息维护"></asp:ETitle>
...
<td><asp:EChoose runat="server" ID ="txtSxm"  DataField="SXM" ECIType="WL" Width="85%"></asp:EChoose></td>

               </tr>
   <tr>
                        <td class="lbl">使用砂芯数量</td>
<td><asp:ETextBox runat="server" ID ="txtSxsl"  DataField="SXSL" Width="85%"></asp:ETextBox></td>
                        <td class="lbl">备注</td>
