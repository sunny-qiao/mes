...
public partial class AppMes_BaseData_frmMesBdSjkbgList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdSjkbgSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdSjkbgDelete);
