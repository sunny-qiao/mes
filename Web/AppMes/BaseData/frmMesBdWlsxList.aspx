<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdWlsxList.aspx.cs" Inherits="AppMes_BaseData_frmMesBdWlsxList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function addAction() {
            var url = "frmMesBdWlsxEdit.aspx";
            eci.open(url);
        }

        function editAction(obj) {
            var key = $(obj).getKey();
            var url = "frmMesBdWlsxEdit.aspx?key=" + key;
            eci.open(url);
        }
...
<body>
    <form id="form1" runat="server">
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="物料属性"></asp:ETitle>
...
<th style="width: 20%"></th>
                        ...
                        <tr>
                        <td class="lbl">物料属性编号</td>
<td><asp:ETextBox runat="server" ID ="txtBh"  DataField="BH" Query="A.BH|string|like" Width="85%"></asp:ETextBox></td>
                        <td class="lbl">物料属性</td>
<td><asp:ETextBox runat="server" ID ="txtWlsx"  DataField="WLSX" Query="A.WLSX|string|like" Width="85%"></asp:ETextBox></td>
            ...
            <div id="datagrid">
                ...
                <asp:EGridView ID="gvData" Layout="divQuery,toolbar,pagetitle" runat="server" 
                    ...
                    <Columns>
                      ...
                      <asp:BoundField DataField="BH" HeaderText="物料属性编号" SortExpression="BH"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="WLSX" HeaderText="物料属性" SortExpression="WLSX"  ItemStyle-Width="150"></asp:BoundField>
