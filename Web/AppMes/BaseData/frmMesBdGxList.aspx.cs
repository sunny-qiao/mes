...
public partial class AppMes_BaseData_frmMesBdGxList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdGxSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdGxDelete);
