...
public partial class AppMes_BaseData_frmMesBdWhcdList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdWhcdSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdWhcdDelete);
