...
public partial class AppMes_BaseData_frmMesBdWlplCpxsList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdWlplCpxsSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdWlplCpxsDelete);
