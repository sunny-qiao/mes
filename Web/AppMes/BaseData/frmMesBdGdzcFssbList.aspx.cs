...
public partial class AppMes_BaseData_frmMesBdGdzcFssbList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdGdzcFssbSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdGdzcFssbDelete);
