<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdCpxsDocList.aspx.cs" Inherits="AppMes_BaseData_frmMesBdCpxsDocList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>产品型式子表-文件录入</title>
    ...
    <script type="text/javascript">
        ...
        function addAction() {
            var url = "frmMesBdCpxsDocEdit.aspx";
            eci.open(url);
        }

        function editAction(obj) {
            var key = $(obj).getKey();
            var url = "frmMesBdCpxsDocEdit.aspx?key=" + key;
            eci.open(url);
        }
...
<body>
    <form id="form1" runat="server">
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="产品型式子表-文件录入"></asp:ETitle>
...
<td><asp:EChoose runat="server" ID ="txtName"  DataField="NAME" Query="A.NAME|string|like" ECIType="CPXS" Width="85%"></asp:EChoose></td>
                        <td class="lbl">文件类别</td>
<td><asp:ETextBox runat="server" ID ="txtFileType"  DataField="FILE_TYPE" Query="A.FILE_TYPE|string|like" Width="85%"></asp:ETextBox></td>
            ...
            <div id="datagrid">
                ...
                <asp:EGridView ID="gvData" Layout="divQuery,toolbar,pagetitle" runat="server" 
                    ...
                    <Columns>
                      ...
                      <asp:BoundField DataField="NAME" HeaderText="产品型式" SortExpression="NAME"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="FILE_TYPE" HeaderText="文件类别" SortExpression="FILE_TYPE"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="DOC" HeaderText="文件名" SortExpression="DOC"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="DOC_PATH" HeaderText="文件保存位置" SortExpression="DOC_PATH"  ItemStyle-Width="150"></asp:BoundField>
