...
public partial class AppMes_BaseData_frmMesBdCpxsMjList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdCpxsMjSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdCpxsMjDelete);
