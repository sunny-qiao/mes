<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdZyDocList.aspx.cs" Inherits="AppMes_BaseData_frmMesBdZyDocList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function addAction() {
            var url = "frmMesBdZyDocEdit.aspx";
            eci.open(url);
        }

        function editAction(obj) {
            var key = $(obj).getKey();
            var url = "frmMesBdZyDocEdit.aspx?key=" + key;
            eci.open(url);
        }
