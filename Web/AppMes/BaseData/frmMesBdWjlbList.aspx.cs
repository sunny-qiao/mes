...
public partial class AppMes_BaseData_frmMesBdWjlbList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdWjlbSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdWjlbDelete);
