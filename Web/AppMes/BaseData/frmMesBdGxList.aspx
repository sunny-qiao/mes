<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdGxList.aspx.cs" Inherits="AppMes_BaseData_frmMesBdGxList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function editAction(obj) {
            var key = $(obj).getKey();
            var url = "frmMesBdGxEdit.aspx?key=" + key;
            eci.open(url);
        }
...
<body>
    <form id="form1" runat="server">
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="工序"></asp:ETitle>
            ...
            <div id="datagrid">
                ...
                <asp:EGridView ID="gvData" Layout="divQuery,toolbar,pagetitle" runat="server" 
                    ...
                    <Columns>
                      ...
                      <asp:BoundField DataField="BH" HeaderText="工序编号" SortExpression="BH"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="NAME" HeaderText="工序名" SortExpression="NAME"  ItemStyle-Width="150"></asp:BoundField>
                      ...
                      <asp:BoundField DataField="CKCPQZM" HeaderText="默认出库产品前置名" SortExpression="CKCPQZM"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="RKCPQZM" HeaderText="默认入库产品前置名" SortExpression="RKCPQZM"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="BMCLYL" HeaderText="表面处理用原料" SortExpression="BMCLYL"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="MD" HeaderText="该表面处理原料密度kg/cm^3" SortExpression="MD"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="YLSH" HeaderText="理论表面处理原料损耗百分比" SortExpression="YLSH"  ItemStyle-Width="150"></asp:BoundField>
