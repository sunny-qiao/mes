...
public partial class AppMes_BaseData_frmMesBdBgwjlbList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdBgwjlbSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdBgwjlbDelete);
