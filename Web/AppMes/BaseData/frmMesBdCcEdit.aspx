<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdCcEdit.aspx.cs" Inherits="AppMes_BaseData_frmMesBdCcEdit" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="尺寸类别维护"></asp:ETitle>
...
<td><asp:ETextBox runat="server" ID ="txtName"  DataField="NAME" Width="85%"></asp:ETextBox></td>
   ...
   <tr>
                        <td class="lbl">尺寸精度</td>
<td><asp:ETextBox runat="server" ID ="txtJd"  DataField="JD" IsFloat="true" Width="85%"></asp:ETextBox></td>
                        <td class="lbl">备注</td>
