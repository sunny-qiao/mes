<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdCkEdit.aspx.cs" Inherits="AppMes_BaseData_frmMesBdCkEdit" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="仓库维护"></asp:ETitle>
...
<td><asp:ETextBox runat="server" ID ="txtName"  DataField="NAME" NotNull="true" Width="85%"></asp:ETextBox></td>
   ...
   <tr>
                        <td class="lbl">是否虚拟仓库</td>
<td><asp:ECombox runat="server" ID ="cboIsXnck"  DataField="IS_XNCK" AddEmpty="true" ECIType="ISUSE" Width="85%"></asp:ECombox></td>
                        <td class="lbl">备注</td>
