...
public partial class AppMes_BaseData_frmMesBdBcList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdBcSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdBcDelete);
