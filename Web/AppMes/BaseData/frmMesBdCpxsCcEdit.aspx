<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdCpxsCcEdit.aspx.cs" Inherits="AppMes_BaseData_frmMesBdCpxsCcEdit" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>产品型式子表-尺寸录入维护</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="产品型式子表-尺寸录入维护"></asp:ETitle>
...
<td><asp:ETextBox runat="server" ID ="txtBh"  DataField="BH" Width="85%"></asp:ETextBox></td>
                        <td class="lbl">尺寸名</td>
<td><asp:ETextBox runat="server" ID ="txtCcm"  DataField="CCM" Width="85%"></asp:ETextBox></td>
