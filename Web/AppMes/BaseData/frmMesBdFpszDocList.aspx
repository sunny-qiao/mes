<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdFpszDocList.aspx.cs" Inherits="AppMes_BaseData_frmMesBdFpszDocList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>废品设置子表-文件录入</title>
    ...
    <script type="text/javascript">
        ...
        function addAction() {
            var url = "frmMesBdFpszDocEdit.aspx";
            eci.open(url);
        }

        function editAction(obj) {
            var key = $(obj).getKey();
            var url = "frmMesBdFpszDocEdit.aspx?key=" + key;
            eci.open(url);
        }
...
<body>
    <form id="form1" runat="server">
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="废品设置子表-文件录入"></asp:ETitle>
