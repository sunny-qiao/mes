...
public partial class AppMes_BaseData_frmMesBdWlzplList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdWlzplSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdWlzplDelete);
