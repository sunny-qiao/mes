<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdScxFpList.aspx.cs" Inherits="AppMes_BaseData_frmMesBdScxFpList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>生产线子表-废品设置</title>
    ...
    <script type="text/javascript">
        ...
        function editAction(obj) {
            var key = $(obj).getKey();
            var url = "frmMesBdScxFpEdit.aspx?key=" + key;
            eci.open(url);
        }
...
<body>
    <form id="form1" runat="server">
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="生产线子表-废品设置"></asp:ETitle>
...
<td><asp:ETextBox runat="server" ID ="txtBh"  DataField="BH" Query="A.BH|string|like" Width="85%"></asp:ETextBox></td>
                        <td class="lbl">废品名</td>
<td><asp:ETextBox runat="server" ID ="txtFpm"  DataField="FPM" Query="A.FPM|string|like" Width="85%"></asp:ETextBox></td>
            ...
            <div id="datagrid">
                ...
                <asp:EGridView ID="gvData" Layout="divQuery,toolbar,pagetitle" runat="server" 
                    ...
                    <Columns>
                      ...
                      <asp:BoundField DataField="SCX" HeaderText="对应生产线名" SortExpression="SCX"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="BH" HeaderText="编号" SortExpression="BH"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="FPM" HeaderText="废品名" SortExpression="FPM"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="HLLBL" HeaderText="转为回炉料比例" SortExpression="HLLBL"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="HLLRKCK" HeaderText="转为回炉料入库仓库" SortExpression="HLLRKCK"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="EJPBL" HeaderText="转为二级品比例" SortExpression="EJPBL"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="EJPCLGX" HeaderText="二级片处理工序" SortExpression="EJPCLGX"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="EJPRKCK" HeaderText="转为二级品入库仓库" SortExpression="EJPRKCK"  ItemStyle-Width="150"></asp:BoundField>
