<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdWlplCpxsList.aspx.cs" Inherits="AppMes_BaseData_frmMesBdWlplCpxsList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>物料品类子表-对应产品型式</title>
    ...
    <script type="text/javascript">
        ...
        function editAction(obj) {
            var key = $(obj).getKey();
            var url = "frmMesBdWlplCpxsEdit.aspx?key=" + key;
            eci.open(url);
        }
...
<body>
    <form id="form1" runat="server">
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="物料品类子表-对应产品型式"></asp:ETitle>
...
<td><asp:EChoose runat="server" ID ="txtName"  DataField="NAME" Query="A.NAME|string|like" ECIType="WLPL" Width="85%"></asp:EChoose></td>
            ...
            <div id="datagrid">
                ...
                <asp:EGridView ID="gvData" Layout="divQuery,toolbar,pagetitle" runat="server" 
                    ...
                    <Columns>
                      ...
                      <asp:BoundField DataField="CPXS" HeaderText="对应产品型式" SortExpression="CPXS"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="CPXS_LEVEL" HeaderText="优先级别" SortExpression="CPXS_LEVEL"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="REMARK" HeaderText="产品型式1备注" SortExpression="REMARK"  ItemStyle-Width="150"></asp:BoundField>
