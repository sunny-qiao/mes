...
public partial class AppMes_BaseData_frmMesBdWlList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdWlSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdWlDelete);
