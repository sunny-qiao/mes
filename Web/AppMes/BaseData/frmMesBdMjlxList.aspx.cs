...
public partial class AppMes_BaseData_frmMesBdMjlxList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdMjlxSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdMjlxDelete);
