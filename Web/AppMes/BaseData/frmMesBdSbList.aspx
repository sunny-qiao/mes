<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdSbList.aspx.cs" Inherits="AppMes_BaseData_frmMesBdSbList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function editAction(obj) {
            var key = $(obj).getKey();
            var url = "frmMesBdSbEdit.aspx?key=" + key;
            eci.open(url);
        }
...
<body>
    <form id="form1" runat="server">
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="商标"></asp:ETitle>
            ...
            <div id="datagrid">
                ...
                <asp:EGridView ID="gvData" Layout="divQuery,toolbar,pagetitle" runat="server" 
                    ...
                    <Columns>
                      ...
                      <asp:BoundField DataField="BH" HeaderText="商标编号" SortExpression="BH"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="NAME" HeaderText="商标名" SortExpression="NAME"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="CODE" HeaderText="商标代码" SortExpression="CODE"  ItemStyle-Width="150"></asp:BoundField>
                        <asp:ETemplateField HeaderText="商标照片" DataField="PIC" ItemStyle-Width="150">
                            <ItemTemplate>
                                <a href="javascript:void(0);" onclick="eci.open('../../Upload/sbPic/<%#Eval("PIC") %>') "><%#Eval("PIC") %></a>
                            </ItemTemplate>
                        </asp:ETemplateField>
