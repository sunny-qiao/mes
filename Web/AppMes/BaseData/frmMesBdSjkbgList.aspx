<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdSjkbgList.aspx.cs" Inherits="AppMes_BaseData_frmMesBdSjkbgList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function addAction() {
            var url = "frmMesBdSjkbgEdit.aspx";
            eci.open(url);
        }

        function editAction(obj) {
            var key = $(obj).getKey();
            var url = "frmMesBdSjkbgEdit.aspx?key=" + key;
            eci.open(url);
        }
...
<body>
    <form id="form1" runat="server">
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="数据库表格表"></asp:ETitle>
...
<th style="width: 20%"></th>
                        ...
                        <tr>
                        <td class="lbl">数据表编号</td>
<td><asp:ETextBox runat="server" ID ="txtBh"  DataField="BH" Query="A.BH|string|like" Width="85%"></asp:ETextBox></td>
                        <td class="lbl">数据表名</td>
<td><asp:ETextBox runat="server" ID ="txtTablem"  DataField="TABLEM" Query="A.TABLEM|string|like" Width="85%"></asp:ETextBox></td>
                        <td class="lbl">数据库表名</td>
<td><asp:ETextBox runat="server" ID ="txtDbm"  DataField="DBM" Query="A.DBM|string|like" Width="85%"></asp:ETextBox></td>
            ...
            <div id="datagrid">
                ...
                <asp:EGridView ID="gvData" Layout="divQuery,toolbar,pagetitle" runat="server" 
                    ...
                    <Columns>
                      ...
                      <asp:BoundField DataField="BH" HeaderText="数据表编号" SortExpression="BH"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="TABLEM" HeaderText="数据表名" SortExpression="TABLEM"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="DBM" HeaderText="数据库表名" SortExpression="DBM"  ItemStyle-Width="150"></asp:BoundField>
