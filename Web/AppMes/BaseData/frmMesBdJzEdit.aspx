<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdJzEdit.aspx.cs" Inherits="AppMes_BaseData_frmMesBdJzEdit" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="结账设置维护"></asp:ETitle>
...
<td><asp:ETextBox runat="server" ID ="txtQzrq"  DataField="QZRQ" Width="85%"></asp:ETextBox></td>
                        <td class="lbl">日期</td>
<td><asp:ETextBox runat="server" ID ="txtRq"  DataField="RQ" IsDate="true" Width="85%"></asp:ETextBox></td>
                        <td class="lbl">备注</td>
