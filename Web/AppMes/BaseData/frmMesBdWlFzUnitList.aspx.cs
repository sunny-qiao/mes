...
public partial class AppMes_BaseData_frmMesBdWlFzUnitList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdWlFzUnitSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdWlFzUnitDelete);
