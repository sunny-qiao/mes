<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdWlGysEdit.aspx.cs" Inherits="AppMes_BaseData_frmMesBdWlGysEdit" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>物料子表-推荐供货商维护</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="物料子表-推荐供货商维护"></asp:ETitle>
...
<td><asp:EChoose runat="server" ID ="txtGys"  DataField="GYS" ECIType="GYS" Width="85%"></asp:EChoose></td>
   ...
   <tr>
                        <td class="lbl">优先级</td>
<td><asp:ETextBox runat="server" ID ="txtGhsLevel"  DataField="GHS_LEVEL" Width="85%"></asp:ETextBox></td>
                        <td class="lbl">备注</td>
