...
public partial class AppMes_BaseData_frmMesBdMjlxcsList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdMjlxcsSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdMjlxcsDelete);
