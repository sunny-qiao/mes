...
public partial class AppMes_BaseData_frmMesBdGysList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdGysSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdGysDelete);
