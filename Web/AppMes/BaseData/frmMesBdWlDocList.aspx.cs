...
public partial class AppMes_BaseData_frmMesBdWlDocList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdWlDocSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdWlDocDelete);
