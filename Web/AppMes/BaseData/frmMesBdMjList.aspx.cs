...
public partial class AppMes_BaseData_frmMesBdMjList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdMjSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdMjDelete);
