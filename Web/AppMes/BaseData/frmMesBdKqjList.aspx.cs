...
public partial class AppMes_BaseData_frmMesBdKqjList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdKqjSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdKqjDelete);
