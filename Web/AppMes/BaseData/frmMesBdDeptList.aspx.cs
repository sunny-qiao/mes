...
public partial class AppMes_BaseData_frmMesBdDeptList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdDeptSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdDeptDelete);
