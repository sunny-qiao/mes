<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdFpcyEdit.aspx.cs" Inherits="AppMes_BaseData_frmMesBdFpcyEdit" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="废品成因维护"></asp:ETitle>
