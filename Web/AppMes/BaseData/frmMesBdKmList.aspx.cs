...
public partial class AppMes_BaseData_frmMesBdKmList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdKmSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdKmDelete);
