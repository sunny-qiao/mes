...
public partial class AppMes_BaseData_frmMesBdScsjbcsList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdScsjbcsSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdScsjbcsDelete);
