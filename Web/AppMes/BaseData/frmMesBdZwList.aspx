<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdZwList.aspx.cs" Inherits="AppMes_BaseData_frmMesBdZwList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function editAction(obj) {
            var key = $(obj).getKey();
            var url = "frmMesBdZwEdit.aspx?key=" + key;
            eci.open(url);
        }
...
<body>
    <form id="form1" runat="server">
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="职务"></asp:ETitle>
...
<td><asp:ETextBox runat="server" ID ="txtDeptCode"  DataField="DEPT_CODE" Query="A.DEPT_CODE|string|like" Width="85%"></asp:ETextBox></td>
            ...
            <div id="datagrid">
                ...
                <asp:EGridView ID="gvData" Layout="divQuery,toolbar,pagetitle" runat="server" 
                    ...
                    <Columns>
                      ...
                      <asp:BoundField DataField="BH" HeaderText="职务编号" SortExpression="BH"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="NAME" HeaderText="职务名" SortExpression="NAME"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="CODE" HeaderText="职务代码" SortExpression="CODE"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="DEPT_CODE" HeaderText="所属部门" SortExpression="DEPT_CODE"  ItemStyle-Width="150"></asp:BoundField>
