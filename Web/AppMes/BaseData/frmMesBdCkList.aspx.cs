...
public partial class AppMes_BaseData_frmMesBdCkList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdCkSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdCkDelete);
