<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdKqjEdit.aspx.cs" Inherits="AppMes_BaseData_frmMesBdKqjEdit" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="考勤机设置维护"></asp:ETitle>
...
<td><asp:ETextBox runat="server" ID ="txtName"  DataField="NAME" Width="85%"></asp:ETextBox></td>
                        <td class="lbl">考勤机说明</td>
<td><asp:ETextBox runat="server" ID ="txtSm"  DataField="SM" Width="85%"></asp:ETextBox></td>
