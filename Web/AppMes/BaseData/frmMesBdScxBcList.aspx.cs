...
public partial class AppMes_BaseData_frmMesBdScxBcList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdScxBcSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdScxBcDelete);
