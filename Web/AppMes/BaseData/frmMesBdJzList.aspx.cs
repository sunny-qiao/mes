...
public partial class AppMes_BaseData_frmMesBdJzList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdJzSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdJzDelete);
