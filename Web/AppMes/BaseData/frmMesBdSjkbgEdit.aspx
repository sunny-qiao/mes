<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdSjkbgEdit.aspx.cs" Inherits="AppMes_BaseData_frmMesBdSjkbgEdit" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>数据库表格表维护</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="数据库表格表维护"></asp:ETitle>
...
<td><asp:ETextBox runat="server" ID ="txtTablem"  DataField="TABLEM" Width="85%"></asp:ETextBox></td>
                        <td class="lbl">数据库表名</td>
<td><asp:ETextBox runat="server" ID ="txtDbm"  DataField="DBM" Width="85%"></asp:ETextBox></td>
