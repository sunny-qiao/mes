<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdWlGysList.aspx.cs" Inherits="AppMes_BaseData_frmMesBdWlGysList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>物料子表-推荐供货商</title>
    ...
    <script type="text/javascript">
        ...
        function addAction() {
            var url = "frmMesBdWlGysEdit.aspx";
            eci.open(url);
        }

        function editAction(obj) {
            var key = $(obj).getKey();
            var url = "frmMesBdWlGysEdit.aspx?key=" + key;
            eci.open(url);
        }
...
<body>
    <form id="form1" runat="server">
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="物料子表-推荐供货商"></asp:ETitle>
            ...
            <div id="datagrid">
                ...
                <asp:EGridView ID="gvData" Layout="divQuery,toolbar,pagetitle" runat="server" 
                    ...
                    <Columns>
                      ...
                      <asp:BoundField DataField="GYS" HeaderText="推荐供应商" SortExpression="GYS"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="GHS_LEVEL" HeaderText="优先级" SortExpression="GHS_LEVEL"  ItemStyle-Width="150"></asp:BoundField>
