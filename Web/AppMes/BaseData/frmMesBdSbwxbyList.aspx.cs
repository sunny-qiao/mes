...
public partial class AppMes_BaseData_frmMesBdSbwxbyList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdSbwxbySearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdSbwxbyDelete);
