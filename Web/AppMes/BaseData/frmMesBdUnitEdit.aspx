<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdUnitEdit.aspx.cs" Inherits="AppMes_BaseData_frmMesBdUnitEdit" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="计量单位维护"></asp:ETitle>
...
<td><asp:ETextBox runat="server" ID ="txtName"  DataField="NAME" NotNull="true" Width="85%"></asp:ETextBox></td>
                        <td class="lbl">计量单位符号</td>
<td><asp:ETextBox runat="server" ID ="txtUnitFh"  DataField="UNIT_FH" NotNull="true" Width="85%"></asp:ETextBox></td>
