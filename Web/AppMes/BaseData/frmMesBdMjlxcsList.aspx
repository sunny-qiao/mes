<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdMjlxcsList.aspx.cs" Inherits="AppMes_BaseData_frmMesBdMjlxcsList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>模具类型参数设定</title>
    ...
    <script type="text/javascript">
        ...
        function editAction(obj) {
            var key = $(obj).getKey();
            var url = "frmMesBdMjlxcsEdit.aspx?key=" + key;
            eci.open(url);
        }
...
<body>
    <form id="form1" runat="server">
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="模具类型参数设定"></asp:ETitle>
...
<td><asp:EChoose runat="server" ID ="txtMjlx"  DataField="MJLX" Query="A.MJLX|string|like" ECIType="MJLX" Width="85%"></asp:EChoose></td>
                        <td class="lbl">编号</td>
            ...
            <div id="datagrid">
                ...
                <asp:EGridView ID="gvData" Layout="divQuery,toolbar,pagetitle" runat="server" 
                    ...
                    <Columns>
                      ...
                      <asp:BoundField DataField="MJLX" HeaderText="对应模具类型" SortExpression="MJLX"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="BH" HeaderText="编号" SortExpression="BH"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="CSM" HeaderText="对应参数名" SortExpression="CSM"  ItemStyle-Width="150"></asp:BoundField>
