...
public partial class AppMes_BaseData_frmMesBdGysGywlList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdGysGywlSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdGysGywlDelete);
