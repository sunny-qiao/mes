...
public partial class AppMes_BaseData_frmMesBdCpxsDocList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdCpxsDocSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdCpxsDocDelete);
