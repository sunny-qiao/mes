<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdWlplTjEdit.aspx.cs" Inherits="AppMes_BaseData_frmMesBdWlplTjEdit" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>物料品类子表-统计所属其他物料品类维护</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="物料品类子表-统计所属其他物料品类维护"></asp:ETitle>
...
<td><asp:ETextBox runat="server" ID ="txtName"  DataField="NAME" Width="85%"></asp:ETextBox></td>
                        <td class="lbl">统计所属其他物料品类</td>
<td><asp:EChoose runat="server" ID ="txtTjlb"  DataField="TJLB" ECIType="WLPL" Width="85%"></asp:EChoose></td>
