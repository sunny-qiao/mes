<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdMjDocList.aspx.cs" Inherits="AppMes_BaseData_frmMesBdMjDocList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>模具子表-文件录入</title>
    ...
    <script type="text/javascript">
        ...
        function addAction() {
            var url = "frmMesBdMjDocEdit.aspx";
            eci.open(url);
        }

        function editAction(obj) {
            var key = $(obj).getKey();
            var url = "frmMesBdMjDocEdit.aspx?key=" + key;
            eci.open(url);
        }
...
<body>
    <form id="form1" runat="server">
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="模具子表-文件录入"></asp:ETitle>
...
<td><asp:ETextBox runat="server" ID ="txtBh"  DataField="BH" Query="A.BH|string|like" Width="85%"></asp:ETextBox></td>
                        <td class="lbl">模具名</td>
<td><asp:EChoose runat="server" ID ="txtName"  DataField="NAME" Query="A.NAME|string|like" ECIType="MJ" Width="85%"></asp:EChoose></td>
