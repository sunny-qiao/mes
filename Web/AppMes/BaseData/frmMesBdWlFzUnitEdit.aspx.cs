...
public partial class AppMes_BaseData_frmMesBdWlFzUnitEdit : BasePage
{
    private string key
    {
    ...
    {
        EciRequest request = new EciRequest(MESService.MesBdWlFzUnitSave);

        request.IsAdd = this.key.NullOrEmpty();

        MES_BD_WL_FZ_UNIT saveEntity = new MES_BD_WL_FZ_UNIT();
        ...
        MES_BD_WL_FZ_UNIT data = response.Entity.Upgrade<MES_BD_WL_FZ_UNIT>();
