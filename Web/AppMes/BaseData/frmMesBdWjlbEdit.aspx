<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdWjlbEdit.aspx.cs" Inherits="AppMes_BaseData_frmMesBdWjlbEdit" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>文件类别设置维护</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="文件类别设置维护"></asp:ETitle>
...
<td><asp:ETextBox runat="server" ID ="txtWjlbm"  DataField="WJLBM" Width="85%"></asp:ETextBox></td>
                        <td class="lbl">默认保存位置</td>
<td><asp:ETextBox runat="server" ID ="txtBcwz"  DataField="BCWZ" Width="85%"></asp:ETextBox></td>

               </tr>
   <tr>
                        <td class="lbl">默认打开软件</td>
<td><asp:ETextBox runat="server" ID ="txtDkrj"  DataField="DKRJ" Width="85%"></asp:ETextBox></td>
                        <td class="lbl">备注</td>
