...
public partial class AppMes_BaseData_frmMesBdGdzcDeptList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdGdzcDeptSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdGdzcDeptDelete);
