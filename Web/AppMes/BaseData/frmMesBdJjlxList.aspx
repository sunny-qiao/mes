<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdJjlxList.aspx.cs" Inherits="AppMes_BaseData_frmMesBdJjlxList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function addAction() {
            var url = "frmMesBdJjlxEdit.aspx";
            eci.open(url);
        }

        function editAction(obj) {
            var key = $(obj).getKey();
            var url = "frmMesBdJjlxEdit.aspx?key=" + key;
            eci.open(url);
        }
...
<body>
    <form id="form1" runat="server">
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="计件类型"></asp:ETitle>
            ...
            <div id="datagrid">
                ...
                <asp:EGridView ID="gvData" Layout="divQuery,toolbar,pagetitle" runat="server" 
                    ...
                    <Columns>
                      ...
                      <asp:BoundField DataField="BH" HeaderText="计件类型编号" SortExpression="BH"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="NAME" HeaderText="计件类型名" SortExpression="NAME"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="CODE" HeaderText="计件类型代码" SortExpression="CODE"  ItemStyle-Width="150"></asp:BoundField>
