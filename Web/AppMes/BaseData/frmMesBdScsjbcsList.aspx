<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdScsjbcsList.aspx.cs" Inherits="AppMes_BaseData_frmMesBdScsjbcsList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>生产数据表参数设置</title>
    ...
    <script type="text/javascript">
        ...
        function addAction() {
            var url = "frmMesBdScsjbcsEdit.aspx";
            eci.open(url);
        }

        function editAction(obj) {
            var key = $(obj).getKey();
            var url = "frmMesBdScsjbcsEdit.aspx?key=" + key;
            eci.open(url);
        }
...
<body>
    <form id="form1" runat="server">
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="生产数据表参数设置"></asp:ETitle>
            ...
            <div id="datagrid">
                ...
                <asp:EGridView ID="gvData" Layout="divQuery,toolbar,pagetitle" runat="server" 
                    ...
                    <Columns>
                      ...
                      <asp:BoundField DataField="BH" HeaderText="生产数据参数编号" SortExpression="BH"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="NAME" HeaderText="生产数据参数名" SortExpression="NAME"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="JSFS" HeaderText="生产数据计算方式" SortExpression="JSFS"  ItemStyle-Width="150"></asp:BoundField>
