<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdWlplTjList.aspx.cs" Inherits="AppMes_BaseData_frmMesBdWlplTjList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>物料品类子表-统计所属其他物料品类</title>
    ...
    <script type="text/javascript">
        ...
        function addAction() {
            var url = "frmMesBdWlplTjEdit.aspx";
            eci.open(url);
        }

        function editAction(obj) {
            var key = $(obj).getKey();
            var url = "frmMesBdWlplTjEdit.aspx?key=" + key;
            eci.open(url);
        }
...
<body>
    <form id="form1" runat="server">
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="物料品类子表-统计所属其他物料品类"></asp:ETitle>
            ...
            <div id="datagrid">
                ...
                <asp:EGridView ID="gvData" Layout="divQuery,toolbar,pagetitle" runat="server" 
                    ...
                    <Columns>
                      ...
                      <asp:BoundField DataField="NAME" HeaderText="对应物料品类名" SortExpression="NAME"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="TJLB" HeaderText="统计所属其他物料品类" SortExpression="TJLB"  ItemStyle-Width="150"></asp:BoundField>
