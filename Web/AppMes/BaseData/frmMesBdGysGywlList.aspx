<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdGysGywlList.aspx.cs" Inherits="AppMes_BaseData_frmMesBdGysGywlList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>供应商/客户子表格-供应物料</title>
    ...
    <script type="text/javascript">
        ...
        function addAction() {
            var url = "frmMesBdGysGywlEdit.aspx";
            eci.open(url);
        }

        function editAction(obj) {
            var key = $(obj).getKey();
            var url = "frmMesBdGysGywlEdit.aspx?key=" + key;
            eci.open(url);
        }
...
<body>
    <form id="form1" runat="server">
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="供应商/客户子表格-供应物料"></asp:ETitle>
...
<td><asp:ETextBox runat="server" ID ="txtBh"  DataField="BH" Query="A.BH|string|like" Width="85%"></asp:ETextBox></td>
                        <td class="lbl">供应商/客户</td>
<td><asp:EChoose runat="server" ID ="txtGys"  DataField="GYS" Query="A.GYS|string|like" ECIType="GYS" Width="85%"></asp:EChoose></td>
                        <td class="lbl">供应物料名</td>
<td><asp:EChoose runat="server" ID ="txtName"  DataField="NAME" Query="A.NAME|string|like" ECIType="WL" Width="85%"></asp:EChoose></td>
            ...
            <div id="datagrid">
                ...
                <asp:EGridView ID="gvData" Layout="divQuery,toolbar,pagetitle" runat="server" 
                    ...
                    <Columns>
                      ...
                      <asp:BoundField DataField="GYS" HeaderText="供应商/客户" SortExpression="GYS"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="NAME" HeaderText="供应物料名" SortExpression="NAME"  ItemStyle-Width="150"></asp:BoundField>
