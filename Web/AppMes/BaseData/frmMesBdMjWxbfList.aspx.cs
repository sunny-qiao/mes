...
public partial class AppMes_BaseData_frmMesBdMjWxbfList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdMjWxbfSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdMjWxbfDelete);
