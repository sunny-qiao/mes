...
public partial class AppMes_BaseData_frmMesBdGzList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdGzSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdGzDelete);
