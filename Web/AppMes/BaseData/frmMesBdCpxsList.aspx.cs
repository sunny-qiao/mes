...
public partial class AppMes_BaseData_frmMesBdCpxsList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdCpxsSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdCpxsDelete);
