...
public partial class AppMes_BaseData_frmMesBdMjCpList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdMjCpSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdMjCpDelete);
