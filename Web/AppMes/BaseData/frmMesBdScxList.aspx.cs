...
public partial class AppMes_BaseData_frmMesBdScxList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdScxSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdScxDelete);
