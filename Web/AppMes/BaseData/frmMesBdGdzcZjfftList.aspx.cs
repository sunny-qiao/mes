...
public partial class AppMes_BaseData_frmMesBdGdzcZjfftList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdGdzcZjfftSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdGdzcZjfftDelete);
