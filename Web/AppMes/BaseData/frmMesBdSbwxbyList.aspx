<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdSbwxbyList.aspx.cs" Inherits="AppMes_BaseData_frmMesBdSbwxbyList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>设备维修保养设置</title>
    ...
    <script type="text/javascript">
        ...
        function editAction(obj) {
            var key = $(obj).getKey();
            var url = "frmMesBdSbwxbyEdit.aspx?key=" + key;
            eci.open(url);
        }
...
<body>
    <form id="form1" runat="server">
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="设备维修保养设置"></asp:ETitle>
...
<td><asp:EChoose runat="server" ID ="txtName"  DataField="NAME" Query="A.NAME|string|like" ECIType="GDZC" Width="85%"></asp:EChoose></td>
                        <td class="lbl">维修保养内容</td>
<td><asp:ETextBox runat="server" ID ="txtWxbynr"  DataField="WXBYNR" Query="A.WXBYNR|string|like" Width="85%"></asp:ETextBox></td>
            ...
            <div id="datagrid">
                ...
                <asp:EGridView ID="gvData" Layout="divQuery,toolbar,pagetitle" runat="server" 
                    ...
                    <Columns>
                      ...
                      <asp:BoundField DataField="NAME" HeaderText="对应设备名" SortExpression="NAME"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="WXBYNR" HeaderText="维修保养内容" SortExpression="WXBYNR"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="SCX" HeaderText="维修保养对应工作量调用生产线" SortExpression="SCX"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="UNIT" HeaderText="工作量对应单位" SortExpression="UNIT"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="WXBYXE" HeaderText="维修保养工作量限额" SortExpression="WXBYXE"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="TXXE" HeaderText="提醒工作量限额" SortExpression="TXXE"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="ZDXE" HeaderText="工作量最大限额" SortExpression="ZDXE"  ItemStyle-Width="150"></asp:BoundField>
