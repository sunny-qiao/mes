<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdMjCpList.aspx.cs" Inherits="AppMes_BaseData_frmMesBdMjCpList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>模具子表-产品信息</title>
    ...
    <script type="text/javascript">
        ...
        function editAction(obj) {
            var key = $(obj).getKey();
            var url = "frmMesBdMjCpEdit.aspx?key=" + key;
            eci.open(url);
        }
...
<body>
    <form id="form1" runat="server">
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="模具子表-产品信息"></asp:ETitle>
            ...
            <div id="datagrid">
                ...
                <asp:EGridView ID="gvData" Layout="divQuery,toolbar,pagetitle" runat="server" 
                    ...
                    <Columns>
                      ...
                      <asp:BoundField DataField="CPDZ" HeaderText="产品单重/kg" SortExpression="CPDZ"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="CPGS" HeaderText="产品个数" SortExpression="CPGS"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="CPZS" HeaderText="产品总重/kg" SortExpression="CPZS"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="IS_SCCPL" HeaderText="是否计入模具生产成品率" SortExpression="IS_SCCPL"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="IS_GZHSCPL" HeaderText="是否计入工资核算成品率" SortExpression="IS_GZHSCPL"  ItemStyle-Width="150"></asp:BoundField>
