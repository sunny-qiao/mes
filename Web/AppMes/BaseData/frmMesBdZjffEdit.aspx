<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdZjffEdit.aspx.cs" Inherits="AppMes_BaseData_frmMesBdZjffEdit" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="折旧方法维护"></asp:ETitle>
