...
public partial class AppMes_BaseData_frmMesBdCjList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdCjSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdCjDelete);
