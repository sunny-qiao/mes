...
public partial class AppMes_BaseData_frmMesBdScxMjList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdScxMjSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdScxMjDelete);
