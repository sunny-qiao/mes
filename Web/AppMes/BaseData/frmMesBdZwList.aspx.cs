...
public partial class AppMes_BaseData_frmMesBdZwList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdZwSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdZwDelete);
