...
public partial class AppMes_BaseData_frmMesBdFpszDocList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdFpszDocSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdFpszDocDelete);
