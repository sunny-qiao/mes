...
public partial class AppMes_BaseData_frmMesBdZqList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdZqSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdZqDelete);
