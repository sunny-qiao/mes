<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdGxGzszList.aspx.cs" Inherits="AppMes_BaseData_frmMesBdGxGzszList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>工序子表-工种设置</title>
    ...
    <script type="text/javascript">
        ...
        function editAction(obj) {
            var key = $(obj).getKey();
            var url = "frmMesBdGxGzszEdit.aspx?key=" + key;
            eci.open(url);
        }
...
<body>
    <form id="form1" runat="server">
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="工序子表-工种设置"></asp:ETitle>
            ...
            <div id="datagrid">
                ...
                <asp:EGridView ID="gvData" Layout="divQuery,toolbar,pagetitle" runat="server" 
                    ...
                    <Columns>
                      ...
                      <asp:BoundField DataField="IS_ADD" HeaderText="记录表中是否加入该工种员工框" SortExpression="IS_ADD"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="QTY" HeaderText="加入员工框数量" SortExpression="QTY"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="IS_WZ" HeaderText="该工种员工产量是否以员工框为准" SortExpression="IS_WZ"  ItemStyle-Width="150"></asp:BoundField>
