...
public partial class AppMes_BaseData_frmMesBdSbdbList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdSbdbSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdSbdbDelete);
