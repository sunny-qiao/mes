...
public partial class AppMes_BaseData_frmMesBdCityList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdCitySearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdCityDelete);
