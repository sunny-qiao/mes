<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdBzList.aspx.cs" Inherits="AppMes_BaseData_frmMesBdBzList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function editAction(obj) {
            var key = $(obj).getKey();
            var url = "frmMesBdBzEdit.aspx?key=" + key;
            eci.open(url);
        }
...
<body>
    <form id="form1" runat="server">
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="班组"></asp:ETitle>
            ...
            <div id="datagrid">
                ...
                <asp:EGridView ID="gvData" Layout="divQuery,toolbar,pagetitle" runat="server" 
                    ...
                    <Columns>
                      ...
                      <asp:BoundField DataField="BH" HeaderText="班组编号" SortExpression="BH"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="NAME" HeaderText="班组名" SortExpression="NAME"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="CODE" HeaderText="班组代码" SortExpression="CODE"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="GZHSFS" HeaderText="班组工资核算方式" SortExpression="GZHSFS"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="IS_SDKQ" HeaderText="是否手动考勤" SortExpression="IS_SDKQ"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="IS_QYCQ" HeaderText="手动考勤是否默认全员出勤" SortExpression="IS_QYCQ"  ItemStyle-Width="150"></asp:BoundField>
