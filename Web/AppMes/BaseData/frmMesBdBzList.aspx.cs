...
public partial class AppMes_BaseData_frmMesBdBzList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdBzSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdBzDelete);
