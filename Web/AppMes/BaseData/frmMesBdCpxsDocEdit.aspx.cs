...
public partial class AppMes_BaseData_frmMesBdCpxsDocEdit : BasePage
{
    private string key
    {
    ...
    {
        EciRequest request = new EciRequest(MESService.MesBdCpxsDocSave);

        request.IsAdd = this.key.NullOrEmpty();

        MES_BD_CPXS_DOC saveEntity = new MES_BD_CPXS_DOC();
        ...
        MES_BD_CPXS_DOC data = response.Entity.Upgrade<MES_BD_CPXS_DOC>();
