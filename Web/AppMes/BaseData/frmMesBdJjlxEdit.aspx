<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdJjlxEdit.aspx.cs" Inherits="AppMes_BaseData_frmMesBdJjlxEdit" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="计件类型维护"></asp:ETitle>
