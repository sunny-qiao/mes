...
public partial class AppMes_BaseData_frmMesBdCpxsCcList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdCpxsCcSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdCpxsCcDelete);
