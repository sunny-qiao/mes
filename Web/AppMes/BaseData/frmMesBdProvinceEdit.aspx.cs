...
public partial class AppMes_BaseData_frmMesBdProvinceEdit : BasePage
{
    private string key
    {
    ...
    {
        EciRequest request = new EciRequest(MESService.MesBdProvinceSave);

        request.IsAdd = this.key.NullOrEmpty();

        MES_BD_PROVINCE saveEntity = new MES_BD_PROVINCE();
        ...
        MES_BD_PROVINCE data = response.Entity.Upgrade<MES_BD_PROVINCE>();
