...
public partial class AppMes_BaseData_frmMesBdJygdList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdJygdSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdJygdDelete);
