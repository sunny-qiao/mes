<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdWlFzUnitList.aspx.cs" Inherits="AppMes_BaseData_frmMesBdWlFzUnitList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>物料子表-辅助计量单位设置</title>
    ...
    <script type="text/javascript">
        ...
        function addAction() {
            var url = "frmMesBdWlFzUnitEdit.aspx";
            eci.open(url);
        }

        function editAction(obj) {
            var key = $(obj).getKey();
            var url = "frmMesBdWlFzUnitEdit.aspx?key=" + key;
            eci.open(url);
        }
...
<body>
    <form id="form1" runat="server">
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="物料子表-辅助计量单位设置"></asp:ETitle>
            ...
            <div id="datagrid">
                ...
                <asp:EGridView ID="gvData" Layout="divQuery,toolbar,pagetitle" runat="server" 
                    ...
                    <Columns>
                      ...
                      <asp:BoundField DataField="NAME" HeaderText="物料名" SortExpression="NAME"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="BH" HeaderText="编号" SortExpression="BH"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="UNIT" HeaderText="主计量单位" SortExpression="UNIT"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="FZ_UNIT" HeaderText="辅助计量单位" SortExpression="FZ_UNIT"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="FZ_UNIT_RATE" HeaderText="辅助计量单位对基本计量单位换算率" SortExpression="FZ_UNIT_RATE"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="FZ_UNIT_JD" HeaderText="辅助计量单位输入精度" SortExpression="FZ_UNIT_JD"  ItemStyle-Width="150"></asp:BoundField>
