<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdWlsxEdit.aspx.cs" Inherits="AppMes_BaseData_frmMesBdWlsxEdit" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="物料属性维护"></asp:ETitle>
...
<td><asp:ETextBox runat="server" ID ="txtWlsx"  DataField="WLSX" NotNull="true" Width="85%"></asp:ETextBox></td>
                        <td class="lbl">备注</td>
