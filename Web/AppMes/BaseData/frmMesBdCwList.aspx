<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdCwList.aspx.cs" Inherits="AppMes_BaseData_frmMesBdCwList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function editAction(obj) {
            var key = $(obj).getKey();
            var url = "frmMesBdCwEdit.aspx?key=" + key;
            eci.open(url);
        }
...
<body>
    <form id="form1" runat="server">
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="仓位"></asp:ETitle>
...
<td><asp:EChoose runat="server" ID ="txtCk"  DataField="CK" Query="A.CK|string|like" ECIType="CK" Width="85%"></asp:EChoose></td>
            ...
            <div id="datagrid">
                ...
                <asp:EGridView ID="gvData" Layout="divQuery,toolbar,pagetitle" runat="server" 
                    ...
                    <Columns>
                      ...
                      <asp:BoundField DataField="CK" HeaderText="所属仓库名" SortExpression="CK"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="CODE" HeaderText="仓位代码" SortExpression="CODE"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="NAME" HeaderText="仓位名" SortExpression="NAME"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="ADDRESS" HeaderText="仓位位置" SortExpression="ADDRESS"  ItemStyle-Width="150"></asp:BoundField>
