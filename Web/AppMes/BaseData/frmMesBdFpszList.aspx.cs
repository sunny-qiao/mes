...
public partial class AppMes_BaseData_frmMesBdFpszList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdFpszSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdFpszDelete);
