<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdGdzcFssbList.aspx.cs" Inherits="AppMes_BaseData_frmMesBdGdzcFssbList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>固定资产/设备子表-附属设备</title>
    ...
    <script type="text/javascript">
        ...
        function editAction(obj) {
            var key = $(obj).getKey();
            var url = "frmMesBdGdzcFssbEdit.aspx?key=" + key;
            eci.open(url);
        }
...
<body>
    <form id="form1" runat="server">
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="固定资产/设备子表-附属设备"></asp:ETitle>
            ...
            <div id="datagrid">
                ...
                <asp:EGridView ID="gvData" Layout="divQuery,toolbar,pagetitle" runat="server" 
                    ...
                    <Columns>
                      ...
                      <asp:BoundField DataField="NAME" HeaderText="附属设备名" SortExpression="NAME"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="QTY" HeaderText="附属设备数量" SortExpression="QTY"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="ZB" HeaderText="附属设备价值占比" SortExpression="ZB"  ItemStyle-Width="150"></asp:BoundField>
