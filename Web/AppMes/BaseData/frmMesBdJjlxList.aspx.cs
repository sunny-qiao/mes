...
public partial class AppMes_BaseData_frmMesBdJjlxList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdJjlxSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdJjlxDelete);
