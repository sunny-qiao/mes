<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdCpxsDocEdit.aspx.cs" Inherits="AppMes_BaseData_frmMesBdCpxsDocEdit" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>产品型式子表-文件录入维护</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="产品型式子表-文件录入维护"></asp:ETitle>
...
<td><asp:EChoose runat="server" ID ="txtName"  DataField="NAME" ECIType="CPXS" Width="85%"></asp:EChoose></td>
