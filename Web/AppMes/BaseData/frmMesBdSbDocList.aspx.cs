...
public partial class AppMes_BaseData_frmMesBdSbDocList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdSbDocSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdSbDocDelete);
