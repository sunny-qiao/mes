...
public partial class AppMes_BaseData_frmMesBdWlGysList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdWlGysSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdWlGysDelete);
