<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdMjWxbfList.aspx.cs" Inherits="AppMes_BaseData_frmMesBdMjWxbfList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>模具子表-模具维修及报废生产量设置</title>
    ...
    <script type="text/javascript">
        ...
        function editAction(obj) {
            var key = $(obj).getKey();
            var url = "frmMesBdMjWxbfEdit.aspx?key=" + key;
            eci.open(url);
        }
...
<body>
    <form id="form1" runat="server">
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="模具子表-模具维修及报废生产量设置"></asp:ETitle>
...
<td><asp:ETextBox runat="server" ID ="txtWxnrm"  DataField="WXNRM" Query="A.WXNRM|string|like" Width="85%"></asp:ETextBox></td>
            ...
            <div id="datagrid">
                ...
                <asp:EGridView ID="gvData" Layout="divQuery,toolbar,pagetitle" runat="server" 
                    ...
                    <Columns>
                      ...
                      <asp:BoundField DataField="WXNRM" HeaderText="维修内容名" SortExpression="WXNRM"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="PDSCLXM" HeaderText="判断生产量项目" SortExpression="PDSCLXM"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="PDSCE" HeaderText="判断生产额" SortExpression="PDSCE"  ItemStyle-Width="150"></asp:BoundField>
