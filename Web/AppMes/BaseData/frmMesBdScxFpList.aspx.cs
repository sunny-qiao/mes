...
public partial class AppMes_BaseData_frmMesBdScxFpList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdScxFpSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdScxFpDelete);
