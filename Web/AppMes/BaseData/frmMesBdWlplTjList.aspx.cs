...
public partial class AppMes_BaseData_frmMesBdWlplTjList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdWlplTjSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdWlplTjDelete);
