...
public partial class AppMes_BaseData_frmMesBdFpcyList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdFpcySearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdFpcyDelete);
