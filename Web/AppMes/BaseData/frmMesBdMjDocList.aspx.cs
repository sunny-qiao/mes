...
public partial class AppMes_BaseData_frmMesBdMjDocList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdMjDocSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdMjDocDelete);
