<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdGzEdit.aspx.cs" Inherits="AppMes_BaseData_frmMesBdGzEdit" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="工种维护"></asp:ETitle>
...
<td><asp:EChoose runat="server" ID ="txtDeptCode"  DataField="DEPT_CODE" ECIType="DEPT" NotNull="true" Width="85%"></asp:EChoose></td>
                        <td class="lbl">备注</td>
