<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdZyDocEdit.aspx.cs" Inherits="AppMes_BaseData_frmMesBdZyDocEdit" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="root">
           ...
           <%--<asp:ETitle runat="server" ID="pagetitle" Title="文件录入维护"></asp:ETitle>--%>
