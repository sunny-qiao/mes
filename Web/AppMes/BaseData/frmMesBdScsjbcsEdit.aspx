<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdScsjbcsEdit.aspx.cs" Inherits="AppMes_BaseData_frmMesBdScsjbcsEdit" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>生产数据表参数设置维护</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="生产数据表参数设置维护"></asp:ETitle>
...
<td><asp:ETextBox runat="server" ID ="txtJsfs"  DataField="JSFS" Width="85%"></asp:ETextBox></td>
