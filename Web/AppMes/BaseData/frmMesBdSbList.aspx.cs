...
public partial class AppMes_BaseData_frmMesBdSbList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdSbSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdSbDelete);
