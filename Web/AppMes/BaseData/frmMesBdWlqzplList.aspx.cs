...
public partial class AppMes_BaseData_frmMesBdWlqzplList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdWlqzplSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdWlqzplDelete);
