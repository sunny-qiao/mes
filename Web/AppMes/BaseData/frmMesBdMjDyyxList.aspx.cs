...
public partial class AppMes_BaseData_frmMesBdMjDyyxList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdMjDyyxSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdMjDyyxDelete);
