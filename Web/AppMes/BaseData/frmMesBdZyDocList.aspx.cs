...
public partial class AppMes_BaseData_frmMesBdZyDocList : QueryPage
{
    ...
    {
        request.ServiceId = MESService.MesBdZyDocSearch;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
           ...
           string key = btn.CommandArgument;
            ...
            EciRequest request = new EciRequest(MESService.MesBdZyDocDelete);
