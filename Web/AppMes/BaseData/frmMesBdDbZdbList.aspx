<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdDbZdbList.aspx.cs" Inherits="AppMes_BaseData_frmMesBdDbZdbList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>电表设置子表-子电表目录</title>
    ...
    <script type="text/javascript">
        ...
        function editAction(obj) {
            var key = $(obj).getKey();
            var url = "frmMesBdDbZdbEdit.aspx?key=" + key;
            eci.open(url);
        }
...
<body>
    <form id="form1" runat="server">
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="电表设置子表-子电表目录"></asp:ETitle>
...
<td><asp:EChoose runat="server" ID ="txtDbmMain"  DataField="DBM_MAIN" Query="A.DBM_MAIN|string|like" ECIType="DB" Width="85%"></asp:EChoose></td>
                        <td class="lbl">子电表名</td>
<td><asp:EChoose runat="server" ID ="txtDbmSub"  DataField="DBM_SUB" Query="A.DBM_SUB|string|like" ECIType="DB" Width="85%"></asp:EChoose></td>
            ...
            <div id="datagrid">
                ...
                <asp:EGridView ID="gvData" Layout="divQuery,toolbar,pagetitle" runat="server" 
                    ...
                    <Columns>
                      ...
                      <asp:BoundField DataField="DBM_MAIN" HeaderText="主电表名" SortExpression="DBM_MAIN"  ItemStyle-Width="150"></asp:BoundField>
                      <asp:BoundField DataField="DBM_SUB" HeaderText="子电表名" SortExpression="DBM_SUB"  ItemStyle-Width="150"></asp:BoundField>
