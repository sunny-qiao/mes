<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMesBdCwEdit.aspx.cs" Inherits="AppMes_BaseData_frmMesBdCwEdit" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="root">
           ...
           <asp:ETitle runat="server" ID="pagetitle" Title="仓位维护"></asp:ETitle>
...
<th style="width: 20%"></th>
                        ...
                        <tr>
                        <td class="lbl">所属仓库名</td>
<td><asp:EChoose runat="server" ID ="txtCk"  DataField="CK" ECIType="CK" Width="85%"></asp:EChoose></td>
                        <td class="lbl">仓位代码</td>
